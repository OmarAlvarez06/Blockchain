    ...
    def replace_chain(self):
        ...
        for node in network:
            ...
            if response.status_code == 200:
                ...
                if length['length'] > max_length and self.is_chain_valid(chain['chain']):
...
#Creando una direccion para le nodo en puerto 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Isaias', amount=1)
...
#Checar validez de cadena de bloques
...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message':'Houton, tenemos un problema. El Blockchain no es valido!'}
    return jsonify(response), 200
...
def connect_node():
    ...
    response = {'message':'Todos los nodos estan ahora conectados. El TeamCoin contiene los siguientes nodos:',
